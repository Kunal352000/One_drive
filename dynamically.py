                            ...
                            if (
                                ...
                                if file_download_url:
                                    ...
                                    if file_response.status_code == 200:
                                        ...
                                        watermark_size = (120, 120)  # Adjust the size as needed
                                        watermark_image_resized = watermark_image_blended.resize(watermark_size)

                                        # Calculate the position to place the watermark (bottom-right corner)
                                        image_width, image_height = image.size
                                        watermark_width, watermark_height = watermark_image_resized.size
                                        position = (
                                        ...
                                        image.paste(watermark_image_resized, position, watermark_image_resized)
